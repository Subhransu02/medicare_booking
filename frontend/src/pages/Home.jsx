    ...
    <>
      ...
      <section className="hero_section pt-[60px] 2xl:h-[800px]">
        <div className="container">
          <div className="flex flex-col px-5 lg:flex-row gap-[90px] items-center justify-between">
            {/* hero content */}
            <div>
              <div className="lg:w-[570px]">
                <h1 className="text-[36px] leading-[76px] text-headingColor font-[800] md:text-[60px]">
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                <div>
                  ...
                  <p className="text__para mt-[10px] lg:mt-[20px]">
                    Years of Experience
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <Link
                  to="/doctors"
                  className="w-[44px] h-[44px] rounded-full border border-solid [#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor"
                >
      ...
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            {/*feature img*/}
            <div className="relative z-10 xl:wl-[770px] flex justify-end mt-[50px] lg:mt-0">
